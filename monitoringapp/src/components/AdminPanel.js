...
const AdminPanel = () => {
  const { metricsConfig, updateMetricConfig, addMetric, removeMetric, clearAllMetrics } = useMetrics();
    ...
    <div className="admin-panel">
      <div className="admin-header">
        ...
        <div className="admin-actions">
          ...
          <button className="clear-all-btn" onClick={handleClearAllMetrics}>Clear All Metrics</button>
        </div>
      </div>
        ...
        <div className="metrics-list">
          ...
          {metricsConfig.length === 0 ? (
            <div className="no-metrics">
              No metrics configured. Click "Add New Metric" to get started.
            </div>
          ) : (
